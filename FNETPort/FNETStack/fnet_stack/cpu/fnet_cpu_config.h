 ...
 *            - @c FNET_CFG_CPU_LPC1768 = Used platform is the LPC1768.
 *            - @c FNET_CFG_CPU_LPC1788 = Used platform is the LPC1788.
 *            @n @n
...
#endif 
#ifndef FNET_CFG_CPU_LPC1768
    #define FNET_CFG_CPU_LPC1768  	(0)
#endif
...
/*********** NXP's LPC ********************/
#if FNET_CFG_CPU_LPC1768 /* NXP's LPC1768 MCU */
    #ifdef FNET_CPU_STR
        #error "More than one CPU selected FNET_CPU_XXXX"
    #endif
    #include "cpu/lpc/fnet_lpc1768_config.h"
